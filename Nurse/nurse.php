 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="#" id="register">Register Prison Patients</a>
                </li>
                <li>
                    <a href="#" id="view">View Previous Medical Records</a>
                </li>
              </ul>
...
<div class="body-content" style="display: none;">
  ...
  <h1 style="color: white" style="top: 40px;"> <b> REGISTER NEW PATIENT </b></h1>
    <form class="form" action="nurse.php" method="post" enctype="multipart/form-data" autocomplete="off">
        <input type="text" placeholder="First Name" name="firstname" required />
        <input type="text" placeholder="Last Name" name="lastname" required />
        <input type="text" placeholder="Prisoner ID" name="prisoneridnumber" required />    
...
<table class="table">
  <thead class="grey lighten-2">
    <tr>
      ...
      <th scope="col">ID Number</th>
      <th scope="col">Prisoner Type</th>
      <th scope="col">Medical Allergic</th>
      <th scope="col">Medical Description</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<button class="btn btn-block btn-primary" style="width: 20%">Edit Medical Records</button>
                </div>
                  </div>
                  </div>
                </div>
